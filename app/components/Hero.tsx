...
export function Hero() {
  return (
    <section className="relative flex min-h-0 flex-1 w-full min-w-0 overflow-hidden bg-[#9f515e]">
      <div className="mx-auto flex min-h-full w-full min-w-0 max-w-[1440px] flex-col md:grid md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        {/* Coluna esquerda: Imagem */}
        <div className="relative min-h-0 min-w-0 flex-1 w-full md:order-2 md:h-full lg:min-h-[600px]">
        ...
        <div className="flex overflow-hidden min-h-0 min-w-0 shrink flex-col justify-center px-6 py-8 text-white md:order-1 md:px-12 md:py-12 lg:px-20 lg:py-24">
          ...
          <p className="mb-8 max-w-md text-base text-white/90 md:text-xl font-light leading-relaxed">
            A excelência veterinária que seu melhor amigo merece. Internações
            24h, consultas e vacinas. Estamos em Matozinhos e atendemos Capim
            Branco, Pedro Leopoldo e região. Aberto todos os dias das 9:00 às
            21:00.
          </p>
