...
export function UsaHelpSection() {
  return (
    <section className="relative w-full overflow-hidden bg-[#e8ddde] px-6 py-20 md:px-10 lg:px-14 xl:py-28">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="flex flex-col justify-center text-center lg:order-1 lg:text-left">
          ...
          <p className="mb-8 max-w-xl text-lg leading-relaxed text-gray-600 md:text-xl lg:mx-0 mx-auto">
            ...
            Matozinhos, Capim Branco, Pedro Leopoldo e região.
          </p>

          <div className="flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
            <a
              href="#quem-somos"
              className="inline-flex items-center justify-center rounded-full bg-[#9f515e] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#9f515e]/30 transition hover:bg-[#7d4049] hover:-translate-y-0.5"
            >
